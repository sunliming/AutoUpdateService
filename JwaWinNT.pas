...
{ 								               }
{ The original file is: winnt.h, released June 2000. The original Pascal       }
...
//
  ...
  MAXIMUM_NUMA_NODES = 16;
  {$EXTERNALSYM MAXIMUM_NUMA_NODES}

type
  _SYSTEM_NUMA_INFORMATION = record
    HighestNodeNumber: DWORD;
    Reserved: DWORD;
    case Integer of
      0: (ActiveProcessorsAffinityMask: array [0..MAXIMUM_NUMA_NODES - 1] of ULONGLONG);
      1: (AvailableMemory: array [0..MAXIMUM_NUMA_NODES - 1] of ULONGLONG);
  end;
  {$EXTERNALSYM _SYSTEM_NUMA_INFORMATION}
  SYSTEM_NUMA_INFORMATION = _SYSTEM_NUMA_INFORMATION;
  {$EXTERNALSYM SYSTEM_NUMA_INFORMATION}
  PSYSTEM_NUMA_INFORMATION = ^SYSTEM_NUMA_INFORMATION;
  {$EXTERNALSYM PSYSTEM_NUMA_INFORMATION}
  TSystemNumaInformation = SYSTEM_NUMA_INFORMATION;
  PSystemNumaInformation = PSYSTEM_NUMA_INFORMATION;
...
const
  RTL_VRF_FLG_FULL_PAGE_HEAP   = $0001;
  {$EXTERNALSYM RTL_VRF_FLG_FULL_PAGE_HEAP}
  RTL_VRF_FLG_LOCK_CHECKS      = $0002;
  {$EXTERNALSYM RTL_VRF_FLG_LOCK_CHECKS}
  RTL_VRF_FLG_HANDLE_CHECKS    = $0004;
  {$EXTERNALSYM RTL_VRF_FLG_HANDLE_CHECKS}
  RTL_VRF_FLG_STACK_CHECKS     = $0008;
  {$EXTERNALSYM RTL_VRF_FLG_STACK_CHECKS}
  RTL_VRF_FLG_APPCOMPAT_CHECKS = $0010;
...
//
  ...
  APPLICATION_VERIFIER_RESERVED_BIT_28  = $10000000;
  {$EXTERNALSYM APPLICATION_VERIFIER_RESERVED_BIT_28}
...
type
  PASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION = ^ASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION;
  {$EXTERNALSYM PASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION}
  _ASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION = record
    ulFlags: DWORD;
  ...
  ASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION = _ASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION;
  {$EXTERNALSYM ASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION}
  TAssemblyDllRedirectionDetailedInformation = ASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION;
  PAssemblyDllRedirectionDetailedInformation = PASSEMBLY_DLL_REDIRECTION_DETAILED_INFORMATION;
  ...
  PFINDFIRSTACTIVATIONCONTEXTSECTION = ^FINDFIRSTACTIVATIONCONTEXTSECTION;
  {$EXTERNALSYM PFINDFIRSTACTIVATIONCONTEXTSECTION}
  _FINDFIRSTACTIVATIONCONTEXTSECTION = record
    Size: DWORD;
    Flags: DWORD;
    ExtensionGuid: PGUID;
    Id: DWORD;
  ...
  {$EXTERNALSYM _FINDFIRSTACTIVATIONCONTEXTSECTION}
  FINDFIRSTACTIVATIONCONTEXTSECTION = _FINDFIRSTACTIVATIONCONTEXTSECTION;
  {$EXTERNALSYM FINDFIRSTACTIVATIONCONTEXTSECTION}
  TFindFirstActivationContextSection = FINDFIRSTACTIVATIONCONTEXTSECTION;
